...
- 55 structured diagnostic codes across eight producers with typed parameters, localized templates, source ranges, related locations, stable identity, and legacy/WASM compatibility.
...
| Diagnostic registry | 55 codes, eight producers, schemas, ownership, parity, ranges, and locale coverage match the v1 manifest. | frozen | Contract changes require explicit registry, resource, test, inventory, and baseline review. |
