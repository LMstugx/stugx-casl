...
| Diagnostic registry | The original 55-code Phase 14 set remains unchanged; Phase 19A extends it to 64 and Phase 20F appends twelve linker codes for 76 reviewed entries. | frozen with reviewed extensions | Contract changes require explicit registry, resource, test, inventory, and baseline review. |
