...
- No-argument and up to three-argument C++ `int` functions are supported, but stack arguments, recursion, stack-frame locals, arrays, pointers, classes, templates, strings, and floats are unsupported.
