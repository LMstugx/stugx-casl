...
- COMET microcycle stepping uses the deterministic stugx.CASL teaching microarchitecture and does not model physical timing. Reverse execution and multi-program linking are not production features.
