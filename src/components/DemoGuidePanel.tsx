      ...
      <details className="project-overview" data-testid="project-overview">
        ...
        <div className="demo-guide-body project-overview-body">
          ...
          <div>
            ...
            <p>Start with CASL: GR2 Addition, then C++: Addition, Function Call, Function Argument, Function Arguments, If Else, While Sum, For Sum Sugar, and Break Continue.</p>
          </div>
          <div>
            <h3>Supported C++ subset</h3>
            <p>
              int main, no-argument and up to three-argument int functions, int variables, assignment, +, -, return, if/else, while, for, break/continue, i++, i--, +=, and -=.
            </p>
          </div>
          <div>
