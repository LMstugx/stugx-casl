...
const diagnosticTranslationKeys = {
  ...
  "linker.invalidProjectIdentity": "diagnostics.linker.invalidProjectIdentity",
  "linker.invalidModuleOrder": "diagnostics.linker.invalidModuleOrder",
  "linker.missingMainModule": "diagnostics.linker.missingMainModule",
  "linker.invalidProgramName": "diagnostics.linker.invalidProgramName",
  "linker.duplicateExportedProgram": "diagnostics.linker.duplicateExportedProgram",
  "linker.unresolvedExternalSymbol": "diagnostics.linker.unresolvedExternalSymbol",
  "linker.duplicateRelocationTarget": "diagnostics.linker.duplicateRelocationTarget",
  "linker.relocationOverflow": "diagnostics.linker.relocationOverflow",
  "linker.projectMemoryOverflow": "diagnostics.linker.projectMemoryOverflow",
  "linker.moduleAssemblyNotReady": "diagnostics.linker.moduleAssemblyNotReady",
  "linker.staleModuleAssembly": "diagnostics.linker.staleModuleAssembly",
  "linker.linkedImageStale": "diagnostics.linker.linkedImageStale",
