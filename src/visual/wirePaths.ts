...
export function buildWirePaths({ grIndex = 1, memoryAddress = 0x27 }: WirePathOptions = {}): readonly WirePath[] {
  ...
  return Object.freeze([
    { id: "pr-to-mar", role: "control", d: `${moveTo(prRight)} ${cubicTo({ x: 520, y: 22 }, { x: 650, y: 22 }, marLeft)}` },
    { id: "pr-to-plus2", role: "control", d: `${moveTo(prRight)} ${lineTo({ x: circuitLayout.addressResult.x, y: prRight.y })}` },
    { id: "plus2-to-sp", role: "control", d: `M ${circuitLayout.addressResult.x + circuitLayout.addressResult.w} ${prRight.y} L ${circuitLayout.sp.x} ${prRight.y}` },
    { id: "sp-to-mar", role: "control", d: `M ${circuitLayout.sp.x + circuitLayout.sp.w} ${prRight.y} L ${marLeft.x} ${marLeft.y}` },
    { id: "mar-to-memory", role: "control", d: `${moveTo(marRight)} ${cubicTo({ x: 925, y: marRight.y }, { x: 925, y: memoryLeft.y }, memoryLeft)}` },
    ...
    { id: "mdr-to-gr", role: "data", d: `${moveTo(mdrLeft)} ${cubicTo({ x: 766, y: 188 }, { x: 600, y: 182 }, { x: grRight.x + 42, y: grRight.y })} ${lineTo(grRight)}` },
    { id: "gr-to-mdr", role: "data", d: `${moveTo(grRight)} ${cubicTo({ x: grRight.x + 54, y: grRight.y }, { x: 610, y: 182 }, { x: 742, y: 188 })} ${cubicTo({ x: 786, y: 190 }, { x: mdrLeft.x - 24, y: mdrLeft.y }, mdrLeft)}` },
    ...
    { id: "address-to-gr", role: "data", d: `${moveTo(marLeft)} ${cubicTo({ x: 690, y: 118 }, { x: grRight.x + 48, y: grLeft.y }, grLeft)}` },
    { id: "address-to-pr", role: "control", d: `${moveTo(marLeft)} ${cubicTo({ x: 686, y: 16 }, { x: 520, y: 18 }, prLeft)}` },
